...
EASYCL_INSTANTIATE_FOR_TYPE(double);
...
EASYCL_INSTANTIATE_FOR_TYPE(int8_t);
EASYCL_INSTANTIATE_FOR_TYPE(uint8_t);
EASYCL_INSTANTIATE_FOR_TYPE(int16_t);
EASYCL_INSTANTIATE_FOR_TYPE(uint16_t);
